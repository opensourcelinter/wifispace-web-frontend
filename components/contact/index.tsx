    ...
    <>
      <main className="min-h-screen bg-light">
        <section className="bg-linear-to-br from-primary/10 to-secondary/5 py-20 md:py-32 text-center px-6">
          ...
          >
            We're a Lagos team — reach us fast on WhatsApp, call, or fill the
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              <Card className="text-center hover:border-primary/50 transition-all">
                ...
                <CardContent>
                  ...
                  >
                    <a
                      href="https://wa.me/234XXXXXXXXXX?text=Hi%20Wifibase%2C%20I%20need%20help%20with..."
                      target="_blank"
        ...
        <section className="py-20 text-center px-6 bg-primary/5">
          ...
          <Button asChild size="lg" className="rounded-full px-12">
            <a href="https://wa.me/234XXXXXXXXXX?text=Hi%20Wifibase%2C%20I'm%20reaching%20out%20from%20your%20contact%20page">
              Open WhatsApp Now
            </a>
          </Button>
        </section>
